...
const DetailScreen = (props) => {
  ...
  const linkRenderItem = ({item, index}) => {
    return (
                ...
                <View key={index}>
                  {
                      item.itemId === itemId &&
                      <View>
                        <Text style={{fontSize: 27, fontWeight: "bold"}}>{item.title}</Text>
                        <Text style={{fontSize: 15, fontWeight: "bold"}}>{item.desp}</Text>
                        <Text style={{fontSize: 10, fontWeight: "bold", color: "gray"}}>{item.dateTime} - {item.time} |
                        ...
                        <FlatList data={imageData} renderItem={renderItem} horizontal={true}
